...
function PulseEnviarLeadParaPlanilha(post){
 ...
 fetch(pulseLeadWebhookUrl, {
 'method':'POST',
 'mode':'no-cors',
 'body':payload,
 'keepalive':true
 }).catch(function(error){console.error('Erro ao enviar lead para planilha:', error);});
 return true;
}
...
'funcao_sucesso' :async function(retorno){
 PulseEnviarLeadParaPlanilha(post);
 let phone = '';
 let email = '';
 try{
